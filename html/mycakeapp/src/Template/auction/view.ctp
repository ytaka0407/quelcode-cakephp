...
<table class="vertical-table">
    ...
    <tr>
        <th class="small" scope="row">商品名</th>
    ...
    <tr>
        <th class="small" scope="row">終了時間</th>
        <td><?= h($biditem->endtime) ?></td>
    <tr>
        <th class="small" scope="row">投稿時間</th>
        <td><?= h($biditem->created) ?></td>
    </tr>
    <tr>
        <th class="small" scope="row">終了した？</th>
...
<div class="related">
    ...
    <table cellpaddint="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col">入札者</th>
                <th scope="col">金額</th>
